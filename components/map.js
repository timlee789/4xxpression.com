...
function map() {
  return (
    <div class='mt-12 mb-12 '>
        <div class='text-sm mb-2 font-bold px-4 py-2 text-blue-600'>The Stores which are selling 4X Xpression, Brazilian Trio Bundle, Soprano Clip Hair</div>
      ...
      <div class='mt-4 px-6 text-sm text-slate-400'>
            <ul className='font-bold'>
                ...
                <li>MINS BEAUTY - 4919 Flat Shoals Pkwy 104 Decatur GA 30034</li>
